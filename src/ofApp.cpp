...
void ofApp::setup()
{
    ...
    beams.push_back(Beam(1, 28, 0x9a278b, false)); //purple
    beams.push_back(Beam(2, 40, 0xeb273c, true )); //red
    beams.push_back(Beam(3, 52, 0x07abd5, false)); //blue
    beams.push_back(Beam(4, 64, 0xfab216, true )); //orange
